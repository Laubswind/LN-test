...
router.get("/channels/active", async (req: Request, res: Response) => {
  try {
    ...
    res.json({ success: true, data: serializeBigInt(channels) });
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
});
...
router.get("/payments", async (req: Request, res: Response) => {
  try {
    ...
    res.json({ success: true, data: serializeBigInt(payments) });
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
});
...
router.get("/invoices", async (req: Request, res: Response) => {
  try {
    ...
    res.json({ success: true, data: serializeBigInt(invoices) });
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
});
...
router.get("/transactions", async (req: Request, res: Response) => {
  try {
    ...
    res.json({ success: true, data: serializeBigInt(transactions) });
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
});
